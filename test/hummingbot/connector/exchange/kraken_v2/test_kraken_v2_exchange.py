...
class KrakenV2ExchangeTests(AbstractExchangeConnectorTests.ExchangeConnectorTests):
    ...
    def create_exchange_instance(self):
        ...
        return KrakenV2Exchange(
            client_config_map=client_config_map,
            kraken_v2_api_key=self.api_key,
            kraken_v2_secret_key=self.api_secret,
    ...
    def validate_order_creation_request(self, order: InFlightOrder, request_call: RequestCall):
        ...
        self.assertEqual(KrakenV2Exchange.kraken_v2_order_type(OrderType.LIMIT), request_data["ordertype"])
            ...
            "data": [
                {
                    ...
                    "order_userref": order.client_order_id,
                    "exec_id": "TGBB7L-HT5LX-J3BZ4A",
                    "exec_type": "trade",
                    "trade_id": 62887576,
                    "symbol": self.ws_ex_trading_pairs,
                    "side": "sell",
                    "last_qty": 0.005,
                    "last_price": 26599.9,
                    "liquidity_ind": "t",
    ...
    @patch("hummingbot.connector.exchange.kraken_v2.kraken_v2_exchange.get_new_numeric_client_order_id")
