...
from hummingbot.connector.exchange.kraken_v2.kraken_v2_utils import build_rate_limits_by_tier
from hummingbot.connector.test_support.network_mocking_assistant import NetworkMockingAssistant
from hummingbot.core.api_throttler.async_throttler import AsyncThrottler


class KrakenV2APIUserStreamDataSourceTest(unittest.TestCase):
    level = 0
    ...
    def setUpClass(cls) -> None:
        ...
        cls.api_tier = KrakenV2APITier.STARTER
    ...
    def setUp(self) -> None:
        ...
        self.connector = KrakenV2Exchange(
            client_config_map=client_config_map,
            kraken_v2_api_key="",
            kraken_v2_secret_key="",
            trading_pairs=[self.trading_pair],
            trading_required=False)

        not_a_real_secret = "kQH5HW/8p1uGOVjbgWA7FunAmGO8lsSUXNsu3eow76sz84Q18fWxnyRzBHCd3pd5nE9qa99HAZtuZuj6F1huXg=="
        self.auth = KrakenV2Auth(api_key="someKey", secret_key=not_a_real_secret, time_provider=self.mock_time_provider)

        self.connector._web_assistants_factory._auth = self.auth
        self.data_source = KrakenV2APIUserStreamDataSource(self.connector,
