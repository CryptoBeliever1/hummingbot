...
class KrakenV2AuthTests(TestCase):
    ...
    @patch("hummingbot.connector.exchange.kraken_v2.kraken_v2_auth.KrakenV2Auth.get_tracking_nonce")
    def test_rest_authenticate(self, mocked_nonce):
        ...
        auth = KrakenV2Auth(api_key=self._api_key, secret_key=self._secret, time_provider=mock_time_provider)
